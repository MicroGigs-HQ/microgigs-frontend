                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-sm font-medium text-gray-700">{truncateAddress(task.poster)}</span>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-lg font-bold text-gray-900">
                                {(Number(task.reward.toString()) / 1e18).toFixed(6)}
                              </span>
                              <span className="text-sm text-gray-500">ETH</span>
                            </div>
                            <span className="text-sm text-gray-500">Due in {daysFromNow(task.deadline)} days</span>
                          </div>
                        </div>
                      </div>
                    )
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-gray-500">Due in {daysFromNow(task.deadline)} days</span>
                        </div>
                      </div>
                    </div>
                  </div>
