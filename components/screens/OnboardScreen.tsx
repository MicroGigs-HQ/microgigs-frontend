    ...
    <MobileNavLayout>
      <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="px-4 pt-12 pb-6 bg-white">
          ...
          {/* Connect Wallet Button/Status centered */}
          <div className="flex justify-center mb-6">
            {!isConnected ? (
              <div className="flex flex-col items-center gap-2">
                {!hasUsername ? (
                  <button
                    ...
                    className="bg-orange-500 hover:bg-orange-600 text-white text-xs font-medium px-6 py-2 rounded-xl transition-colors"
                  >
                    Get Started
                  </button>
                ) : (
                  <Wallet>
                    <ConnectWallet className="bg-orange-500 hover:bg-orange-600 text-white text-xs font-medium px-6 py-2 rounded-xl transition-colors">
                      Connect Wallet
                    </ConnectWallet>
                  </Wallet>
                )}
              ...
              <Wallet className="z-10">
                <div className="bg-green-50 border border-green-200 text-green-700 font-medium px-4 py-2 rounded-xl flex items-center gap-2">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 mb-6 hide-scrollbar">
            {categories.map((category) => (
              <button
                ...
                className={`flex items-center gap-2 px-2 py-1 rounded-full whitespace-nowrap transition-colors ${
